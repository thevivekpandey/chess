...
def compute_loss(
    ...
    # Total loss: policy + value (equal weighting, AlphaZero-style).
    # Self-play needs strong policy signal so the trunk doesn't drift away from
    # MCTS targets between iterations.
